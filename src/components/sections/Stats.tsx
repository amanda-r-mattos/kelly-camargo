...
export default function Stats() {
  return (
    <section className="py-16 md:py-20 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-olive/[0.02] to-transparent pointer-events-none" />

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, i) => (
            <AnimatedSection key={stat.label} delay={i * 0.1}>
              <div className="group relative text-center p-6 md:p-8 rounded-2xl bg-white/60 hover:bg-white hover:shadow-lg hover:shadow-olive/5 transition-all duration-500 border border-transparent hover:border-gold/20">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-olive/10 text-olive mb-4 group-hover:bg-olive group-hover:text-white transition-all duration-300">
